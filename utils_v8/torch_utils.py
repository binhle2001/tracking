...
from utils_v8 import DEFAULT_CFG_DICT, DEFAULT_CFG_KEYS, LOGGER, RANK, __version__
from utils_v8.checks import check_version
...
def model_info_for_loggers(trainer):
    ...
    if trainer.args.profile:  # profile ONNX and TensorRT times
        from utils_v8.benchmarks import ProfileModels
...
def strip_optimizer(f: Union[str, Path] = 'best.pt', s: str = '') -> None:
    ...
    Usage:
        from pathlib import Path
        from utils_v8.torch_utils import strip_optimizer
